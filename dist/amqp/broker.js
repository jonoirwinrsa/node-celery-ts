...
class AmqpBroker {
    ...
    static assert(_a) {
        return __awaiter(this, arguments, void 0, function* ({ channel, exchange, routingKey }) {
    ...
    static doPublish(_a) {
        return __awaiter(this, arguments, void 0, function* ({ body, channel, exchange, options, routingKey }) {
